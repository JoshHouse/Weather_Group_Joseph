...
function WeatherConditionsPage() {
    const weatherConditions = {
        ...
        base: "stations",
        main: { temp: 51.05, feels_like: 47.29, temp_min: 46.53, temp_max: 54.28, pressure: 1021, humidity: 60, sea_level: 1021, grnd_level: 910 },
        visibility: 10000,
        wind: { speed: 9.14, deg: 121, gust: 7.77 },
        rain: { "1h": 2.73 },
        clouds: { all: 83 },
        dt: 1726660758,
            ...
            <div className="weather-container">
                ...
                <div className="columns-container">
                    ...
                    <div className="right-column">
                        ...
                        <p><strong>Humidity:</strong> {weatherConditions.main.humidity}%</p>
                        <p><strong>Pressure:</strong> {weatherConditions.main.pressure} hPa</p>
                    </div>
                </div>
            </div>
        </div>
